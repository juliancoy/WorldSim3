...
StatusApiContext makeStatusApiContext(const StatusApiContextFactoryInput& input) {
    ...
    ctx.api_smooth_scroll_zoom_cmd = input.api_smooth_scroll_zoom_cmd;
    ctx.api_zoom_step_cmd = input.api_zoom_step_cmd;
    ctx.api_scroll_zoom_distance_cmd = input.api_scroll_zoom_distance_cmd;
    ctx.api_scroll_zoom_duration_cmd = input.api_scroll_zoom_duration_cmd;
    ctx.api_alt_zoom_number_multiplier_cmd = input.api_alt_zoom_number_multiplier_cmd;
    ctx.api_smooth_scroll_zoom_state = input.api_smooth_scroll_zoom_state;
    ctx.api_zoom_step_state = input.api_zoom_step_state;
    ctx.api_scroll_zoom_distance_state = input.api_scroll_zoom_distance_state;
    ctx.api_scroll_zoom_duration_state = input.api_scroll_zoom_duration_state;
    ctx.api_alt_zoom_number_multiplier_state = input.api_alt_zoom_number_multiplier_state;
    ...
    ctx.api_ui_cmd_ctrl = input.api_ui_cmd_ctrl;
    ctx.api_ui_cmd_alt = input.api_ui_cmd_alt;
